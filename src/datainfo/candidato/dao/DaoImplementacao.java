package datainfo.candidato.dao;
...
import datainfo.candidato.hibernate.HibernateUtil;
/**
...
public abstract class DaoImplementacao<T> implements DaoInterface<T> {
	...
	// Implementar a verificação se Cpf já existe
	@Override
	public T consultaPorCPF(String cpf) throws Exception {
